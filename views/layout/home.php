<main class="flex-1 w-full">
      ...
      <section class="relative w-full h-[600px] lg:h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div class="absolute inset-0 z-0">
          <img
            alt="Modern luxury villa architecture with pool at twilight"
            class="w-full h-full object-cover"
            data-alt="Modern luxury villa architecture with pool at twilight"
      ...
      <section class="border-t border-border-light dark:border-border-dark bg-white dark:bg-surface-dark">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <p class="text-3xl font-black text-primary mb-1">2,500+</p>
              <p class="text-sm font-medium text-text-muted">Properti Terjual</p>
            </div>
            <div>
              <p class="text-3xl font-black text-primary mb-1">98%</p>
              <p class="text-sm font-medium text-text-muted">Klien Puas</p>
            </div>
            <div>
              <p class="text-3xl font-black text-primary mb-1">150+</p>
              <p class="text-sm font-medium text-text-muted">Agen Berpengalaman</p>
            </div>
            <div>
              <p class="text-3xl font-black text-primary mb-1">15+</p>
              <p class="text-sm font-medium text-text-muted">Kota Besar</p>
            </div>
          </div>
        </div>
      </section>
